...
**Acceptance Criteria:**
- [x] Files renamed via `git mv`
- [x] Class names updated to match
- [x] Namespaces unchanged
- [x] `dotnet build` succeeds
- [x] `dotnet test --filter "FullyQualifiedName~StreamTests.RFC9110"` passes
- [x] `dotnet test --filter "FullyQualifiedName~StreamTests.RFC9111"` passes
...
**Acceptance Criteria:**
- [x] Files renamed via `git mv`
- [x] Class names updated (`Http11EncoderStageRfcTests` → `Http11EncoderStageWireFormatTests`)
- [x] Namespaces unchanged
- [x] `dotnet build` succeeds
...
**Acceptance Criteria:**
- [x] Files renamed via `git mv`
- [x] Class names updated (`Http11DecoderStageChunkedRfcTests` → `Http11DecoderStageChunkedTransferTests`)
- [x] Namespaces unchanged
- [x] `dotnet build` succeeds
...
- [x] Namespaces unchanged
- [x] `dotnet build` succeeds
- [x] `dotnet test --filter "FullyQualifiedName~StreamTests.RFC9112"` passes
...
**Acceptance Criteria:**
- [x] Files renamed via `git mv`
- [x] Class names updated (`Http20DecoderStageRfcTests` → `Http20DecoderStageFrameParsingTests`)
- [x] Namespaces unchanged
- [x] `dotnet build` succeeds
