...
/// HttpClient baseline (<see cref="HttpClientCacheBenchmarks"/>) has no cache and always hits the network.
/// </summary>
[WarmupCount(3)]
[IterationCount(10)]
public class GaudiClientCacheBenchmarks : KestrelBaseClass
{
    [Params(50, 90, 100)]
