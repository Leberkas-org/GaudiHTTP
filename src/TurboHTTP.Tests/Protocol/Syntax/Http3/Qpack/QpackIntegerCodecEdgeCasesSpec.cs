...
public sealed class QpackIntegerCodecEdgeCasesSpec
{
    ...
    public void Should_Encode_When_Value_Fits_In_OneBitPrefix()
    {
        ...
        var bytesWritten = QpackIntegerCodec.Encode(0, prefixBits: 1, prefixFlags: 0x00, ref writer);
    ...
    public void Should_Encode_When_Value_Fits_In_EightBitPrefix()
    {
        var output = new byte[10];
        var writer = SpanWriter.Create(output);
        var bytesWritten = QpackIntegerCodec.Encode(200, prefixBits: 8, prefixFlags: 0x00, ref writer);
    ...
    public void Should_Encode_MultiByteInteger_When_Value_Exceeds_Prefix()
    {
        ...
        var bytesWritten = QpackIntegerCodec.Encode(127, prefixBits: 6, prefixFlags: 0x40, ref writer);
    ...
    public void Should_Encode_LargeInteger_With_Multiple_ContinuationBytes()
    {
        ...
        var bytesWritten = QpackIntegerCodec.Encode(100000, prefixBits: 8, prefixFlags: 0x00, ref writer);
    ...
    public void Should_Encode_With_PrefixFlags_Applied()
    {
        ...
        var bytesWritten = QpackIntegerCodec.Encode(10, prefixBits: 5, prefixFlags: 0xC0, ref writer);
    ...
    public void Should_Decode_IntegerWithContinuationBytes()
    {
        ...
        var writer = SpanWriter.Create(encoded);
        var bytesWritten = QpackIntegerCodec.Encode(1337, prefixBits: 6, prefixFlags: 0x40, ref writer);
    ...
    public void Should_Throw_On_Encode_Negative_Value()
    {
        var ex = Assert.Throws<ArgumentOutOfRangeException>(() =>
        {
            var output = new byte[10];
            var writer = SpanWriter.Create(output);
            QpackIntegerCodec.Encode(-1, prefixBits: 8, prefixFlags: 0x00, ref writer);
        });
    ...
    public void Should_Throw_On_Encode_Invalid_PrefixBits_Zero()
    {
        var ex = Assert.Throws<ArgumentOutOfRangeException>(() =>
        {
            var output2 = new byte[10];
            var writer = SpanWriter.Create(output2);
            QpackIntegerCodec.Encode(100, prefixBits: 0, prefixFlags: 0x00, ref writer);
        });
    ...
    public void Should_Throw_On_Encode_Invalid_PrefixBits_TooLarge()
    {
        var ex = Assert.Throws<ArgumentOutOfRangeException>(() =>
        {
            var output2 = new byte[10];
            var writer = SpanWriter.Create(output2);
            QpackIntegerCodec.Encode(100, prefixBits: 9, prefixFlags: 0x00, ref writer);
        });
