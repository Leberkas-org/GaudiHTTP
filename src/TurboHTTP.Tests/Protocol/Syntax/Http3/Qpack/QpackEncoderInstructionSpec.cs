...
public sealed class QpackEncoderInstructionSpec
{
    ...
    public void Should_ThrowForNegativeCapacity()
    {
        ...
        static void ThrowHelper()
        {
            ...
            QpackEncoderInstructionWriter.WriteSetDynamicTableCapacity(-1, ref writer);
        }
    }
    ...
    public void Should_EncodeInsertWithNameReference_Static()
    {
        ...
        var writer = CreateWriter();
        var written = QpackEncoderInstructionWriter.WriteInsertWithNameReference(1, true, "/index.html", ref writer);
    ...
    public void Should_EncodeInsertWithNameReference_Dynamic()
    {
        ...
        var writer = CreateWriter();
        var written = QpackEncoderInstructionWriter.WriteInsertWithNameReference(0, false, "bar", ref writer);
    ...
    public void Should_ThrowForNegativeNameIndex()
    {
        ...
        static void ThrowHelper()
        {
            var buffer = new byte[1024];
            var writer = SpanWriter.Create(buffer);
            QpackEncoderInstructionWriter.WriteInsertWithNameReference(-1, true, "val"u8, ref writer);
        }
    }
    ...
    {
        var writer = CreateWriter();
        var written = QpackEncoderInstructionWriter.WriteInsertWithLiteralName("x-empty", "", ref writer);
    ...
    public void Should_ThrowForNegativeDuplicateIndex()
    {
        ...
        static void ThrowHelper()
        {
            var buffer = new byte[1024];
            var writer = SpanWriter.Create(buffer);
            QpackEncoderInstructionWriter.WriteDuplicate(-1, ref writer);
        }
    }
}
