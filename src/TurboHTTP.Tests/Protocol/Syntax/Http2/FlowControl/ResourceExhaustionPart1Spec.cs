...
namespace TurboHTTP.Tests.Protocol.Syntax.Http2.FlowControl;
...
public sealed class ResourceExhaustionPart1Spec
{
    ...
    public void Http2FrameDecoder_should_throw_http2_exception_when_101_settings_frames_received()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => EnforceSettingsFloodThreshold(settingsCount));
    }
    ...
    public void Http2FrameDecoder_should_throw_http2_exception_when_1000_continuation_frames_received()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => EnforceContinuationFloodThreshold(continuationCount));
    }
