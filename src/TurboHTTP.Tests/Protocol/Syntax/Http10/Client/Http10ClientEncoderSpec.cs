...
public sealed class Http10ClientEncoderSpec
{
    ...
    [Fact(Timeout = 5000)]
    [Trait("RFC", "RFC1945-5")]
    public void Encode_should_return_zero_and_body_stream_for_request_with_body()
    {
    ...
    [Fact(Timeout = 5000)]
    [Trait("RFC", "RFC1945-5")]
    public async Task EncodeDeferred_should_write_headers_and_body_with_content_length()
    {
