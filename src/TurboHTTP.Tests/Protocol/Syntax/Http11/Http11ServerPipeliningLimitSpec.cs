...
public sealed class Http11ServerPipeliningLimitSpec
{
    ...
    public void ServerStateMachine_should_accept_requests_up_to_limit()
    {
        ...
        var sm = new Http11ServerStateMachine(ops, maxPipelineDepth: 3);
    ...
    {
        var ops = new FakeServerOps();
        var sm = new Http11ServerStateMachine(ops, maxPipelineDepth: 2);
    ...
    {
        var ops = new FakeServerOps();
        var sm = new Http11ServerStateMachine(ops, maxPipelineDepth: 1);
    ...
    {
        var ops = new FakeServerOps();
        var sm = new Http11ServerStateMachine(ops, maxPipelineDepth: 100);
    ...
    public void ServerStateMachine_should_throw_on_invalid_limit()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => new Http11ServerStateMachine(ops, maxPipelineDepth: 0));
        Assert.Throws<ArgumentOutOfRangeException>(() => new Http11ServerStateMachine(ops, maxPipelineDepth: -1));
    }
