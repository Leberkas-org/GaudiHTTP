...
public sealed class Http11NegativePathSpec
{
    ...
    [Fact(Timeout = 5000)]
    [Trait("RFC", "RFC9112-4")]
    public void Http11NegativePath_should_need_more_when_http20_version()
    {
        // HTTP/2.0 is parsed as a valid version by MessageVersionCodec but the decoder
        // does not know to reject it; it returns NeedMore (close-delimited body awaiting EOF).
