...
public sealed class BodyDrainSchedulerSpec
{
    ...
    public void Register_should_emit_body_when_window_available()
    {
        ...
        var flow = MakeFlow();
        var scheduler = new BodyDrainScheduler(target, flow, new CancellationTokenSource(), chunkSize: 1024, hardCap: 16);
    ...
    public void CtsLifecycle_should_create_once_and_dispose_on_complete()
    {
        ...
        var scheduler = new BodyDrainScheduler(target, flow, connCts, chunkSize: 1024, hardCap: 16);
