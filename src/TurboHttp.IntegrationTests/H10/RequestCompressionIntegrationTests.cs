...
public sealed class RequestCompressionIntegrationTests
{
    ...
    [Fact(DisplayName = "ReqCompress-H10-001: gzip request body sent and verified by server")]
    ...
    [Fact(DisplayName = "ReqCompress-H10-002: deflate request body sent and verified")]
    ...
    [Fact(DisplayName = "ReqCompress-H10-003: brotli request body sent and verified")]
    ...
    [Fact(DisplayName = "ReqCompress-H10-004: small body below threshold NOT compressed")]
    ...
    [Fact(DisplayName = "ReqCompress-H10-005: Content-Encoding header set correctly for gzip")]
    ...
    [Fact(DisplayName = "ReqCompress-H10-006: compressed request + decompressed response roundtrip")]
