...
[Collection("TLS")]
public sealed class FeatureInteractionTlsIntegrationTests
{
    private readonly ServerFixture _server;
    private readonly ActorSystemFixture _systemFixture;

    public FeatureInteractionTlsIntegrationTests(ServerFixture server, ActorSystemFixture systemFixture)
    {
        _server = server;
        _systemFixture = systemFixture;
    }

    [Fact(DisplayName = "Interaction-TLS-001: Redirect preserves cookies across hops")]
    ...
    [Fact(DisplayName = "Interaction-TLS-002: Compressed response served from cache")]
    ...
    [Fact(DisplayName = "Interaction-TLS-003: Retry after redirect target returns 503")]
    ...
    [Fact(DisplayName = "Interaction-TLS-004: Cookie survives retry cycle")]
    ...
    [Fact(DisplayName = "Interaction-TLS-005: Vary header separates cache entries with cookies active")]
    ...
    [Fact(DisplayName = "Interaction-TLS-006: Redirect chain accumulates cookies across hops")]
    ...
    [Fact(DisplayName = "Interaction-TLS-007: Cache hit bypasses retry logic")]
