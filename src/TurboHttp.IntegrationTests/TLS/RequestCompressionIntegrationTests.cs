...
public sealed class RequestCompressionIntegrationTests
{
    ...
    [Fact(DisplayName = "ReqCompress-TLS-001: gzip request body sent and verified by server")]
    ...
    [Fact(DisplayName = "ReqCompress-TLS-002: deflate request body sent and verified")]
    ...
    [Fact(DisplayName = "ReqCompress-TLS-003: brotli request body sent and verified")]
    ...
    [Fact(DisplayName = "ReqCompress-TLS-004: small body below threshold NOT compressed")]
    ...
    [Fact(DisplayName = "ReqCompress-TLS-005: Content-Encoding header set correctly for gzip")]
    ...
    [Fact(DisplayName = "ReqCompress-TLS-006: compressed request + decompressed response roundtrip")]
