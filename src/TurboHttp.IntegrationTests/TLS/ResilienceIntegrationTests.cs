...
public sealed class ResilienceIntegrationTests
{
    ...
    private ClientHelper CreateClient() =>
        ClientHelper.CreateClient(_server.HttpsPort, new Version(1, 1), scheme: "https", system: _systemFixture.System);

    [Fact(DisplayName = "Resilience-TLS-001: Content-Length mismatch causes exception or timeout")]
    ...
    [Fact(DisplayName = "Resilience-TLS-002: Corrupt gzip data causes graceful failure")]
    ...
    [Fact(DisplayName = "Resilience-TLS-003: Corrupt brotli data causes graceful failure")]
    ...
    [Fact(DisplayName = "Resilience-TLS-004: Truncated body detected")]
    ...
    [Fact(DisplayName = "Resilience-TLS-005: Slow headers within timeout succeed")]
    ...
    [Fact(DisplayName = "Resilience-TLS-006: Slow body within timeout succeed")]
    ...
    [Fact(DisplayName = "Resilience-TLS-007: Slow headers exceed timeout cause cancellation")]
    ...
    [Fact(DisplayName = "Resilience-TLS-008: Empty response causes exception")]
