...
public sealed class CookieIntegrationTests
{
    ...
    [Fact(DisplayName = "Cookie-002: Secure cookie not sent over plaintext HTTP")]
    ...
    [Fact(DisplayName = "Cookie-003: HttpOnly cookie is sent on subsequent requests")]
    ...
    [Theory(DisplayName = "Cookie-004: SameSite cookie with policy is stored and sent")]
    [InlineData("Strict")]
    [InlineData("Lax")]
    [InlineData("None")]
    ...
    [Fact(DisplayName = "Cookie-005: Expired cookie not sent after Max-Age elapses")]
    ...
    [Fact(DisplayName = "Cookie-006: Domain-scoped cookie is stored")]
    ...
    [Fact(DisplayName = "Cookie-007: Path-scoped cookie sent only for matching path")]
    ...
    [Fact(DisplayName = "Cookie-008: Echo returns empty when no cookies set")]
    ...
    [Fact(DisplayName = "Cookie-009: Multiple Set-Cookie headers all stored")]
    ...
    [Fact(DisplayName = "Cookie-010: Delete cookie via Max-Age=0")]
    ...
    [Fact(DisplayName = "Cookie-011: Set cookie persists across redirect response")]
