...
[Collection("H2")]
public sealed class FeatureInteractionH2IntegrationTests
{
    private readonly ServerFixture _server;
    private readonly ActorSystemFixture _systemFixture;

    public FeatureInteractionH2IntegrationTests(ServerFixture server, ActorSystemFixture systemFixture)
    {
        _server = server;
        _systemFixture = systemFixture;
    }

    [Fact(DisplayName = "Interaction-H2-001: Redirect preserves cookies across hops")]
    ...
    [Fact(DisplayName = "Interaction-H2-002: Compressed response served from cache")]
    ...
    [Fact(DisplayName = "Interaction-H2-003: Retry after redirect target returns 503")]
    ...
    [Fact(DisplayName = "Interaction-H2-004: Cookie survives retry cycle")]
    ...
    [Fact(DisplayName = "Interaction-H2-005: Vary header separates cache entries with cookies active")]
    ...
    [Fact(DisplayName = "Interaction-H2-006: Redirect chain accumulates cookies across hops")]
    ...
    [Fact(DisplayName = "Interaction-H2-007: Cache hit bypasses retry logic")]
