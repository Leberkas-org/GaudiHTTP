...
public sealed class RequestCompressionIntegrationTests
{
    ...
    [Fact(DisplayName = "ReqCompress-H2-001: gzip request body sent and verified by server")]
    ...
    [Fact(DisplayName = "ReqCompress-H2-002: deflate request body sent and verified")]
    ...
    [Fact(DisplayName = "ReqCompress-H2-003: brotli request body sent and verified")]
    ...
    [Fact(DisplayName = "ReqCompress-H2-004: small body below threshold NOT compressed")]
    ...
    [Fact(DisplayName = "ReqCompress-H2-005: Content-Encoding header set correctly for gzip")]
    ...
    [Fact(DisplayName = "ReqCompress-H2-006: compressed request + decompressed response roundtrip")]
