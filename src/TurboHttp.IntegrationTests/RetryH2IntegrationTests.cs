...
public sealed class RetryH2IntegrationTests
{
    private readonly KestrelH2Fixture _fixture;

    public RetryH2IntegrationTests(KestrelH2Fixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact(DisplayName = "Retry-H2-001: GET 408 Request Timeout is retried and eventually returns 408")]
    ...
    [Fact(DisplayName = "Retry-H2-002: GET 503 Service Unavailable is retried and eventually returns 503")]
    ...
    [Fact(DisplayName = "Retry-H2-004: GET 503 with Retry-After seconds header is retried")]
    ...
    [Fact(DisplayName = "Retry-H2-005: GET 503 with Retry-After HTTP-date header is retried")]
    ...
    [Theory(DisplayName = "Retry-H2-006: GET succeed-after-N returns 200 after N-1 failures")]
    [InlineData(2)]
    [InlineData(3)]
    ...
    [Fact(DisplayName = "Retry-H2-007: PUT 503 is retried (PUT is idempotent)")]
    ...
    [Fact(DisplayName = "Retry-H2-008: DELETE 503 is retried (DELETE is idempotent)")]
    ...
    [Fact(DisplayName = "Retry-H2-009: POST 503 is NOT retried (POST is non-idempotent)")]
