...
public sealed class CacheIntegrationTests
{
    ...
    [Fact(DisplayName = "Cache-002: no-cache forces revalidation with server")]
    ...
    [Fact(DisplayName = "Cache-003: no-store response never cached")]
    ...
    [Fact(DisplayName = "Cache-004: ETag revalidation sends If-None-Match")]
    ...
    [Fact(DisplayName = "Cache-005: Last-Modified revalidation sends If-Modified-Since")]
    ...
    [Fact(DisplayName = "Cache-006: Vary header produces different cache entries per header value")]
    ...
    [Fact(DisplayName = "Cache-007: must-revalidate with max-age=0 forces revalidation")]
    ...
    [Fact(DisplayName = "Cache-008: s-maxage respected by shared cache")]
    ...
    [Fact(DisplayName = "Cache-009: Expires header enables caching")]
    ...
    [Fact(DisplayName = "Cache-010: private response cached by private cache")]
    ...
    [Fact(DisplayName = "Cache-011: private response not cached by shared cache")]
