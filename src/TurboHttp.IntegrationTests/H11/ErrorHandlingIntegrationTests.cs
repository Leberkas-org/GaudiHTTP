...
public sealed class ErrorHandlingIntegrationTests
{
    ...
    [Fact(DisplayName = "Error-002: Timeout cancellation aborts in-flight request")]
    ...
    [Fact(DisplayName = "Error-003: Mid-response connection abort raises exception")]
    ...
    [Theory(DisplayName = "Error-004: Large response headers received correctly")]
    [InlineData(1)]
    [InlineData(4)]
    ...
    [Fact(DisplayName = "Error-007: Content-Length 0 returns empty body")]
    ...
    [Theory(DisplayName = "Error-008: 4xx status codes returned as response, not thrown")]
    [InlineData(400)]
    [InlineData(401)]
    [InlineData(403)]
    [InlineData(404)]
    ...
    [Theory(DisplayName = "Error-009: 5xx status codes returned as response, not thrown")]
    [InlineData(500)]
    [InlineData(502)]
    [InlineData(503)]
    ...
    [Fact(DisplayName = "Error-010: Custom X-Unknown headers are accessible")]
