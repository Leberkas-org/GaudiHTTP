...
public sealed class ResilienceIntegrationTests
{
    ...
    [Fact(DisplayName = "Resilience-001: Content-Length mismatch causes exception or timeout")]
    ...
    [Fact(DisplayName = "Resilience-002: Corrupt gzip data causes graceful failure")]
    ...
    [Fact(DisplayName = "Resilience-003: Corrupt brotli data causes graceful failure")]
    ...
    [Fact(DisplayName = "Resilience-004: Truncated body detected")]
    ...
    [Fact(DisplayName = "Resilience-005: Slow headers within timeout succeed")]
    ...
    [Fact(DisplayName = "Resilience-006: Slow body within timeout succeed")]
    ...
    [Fact(DisplayName = "Resilience-007: Slow headers exceed timeout cause cancellation")]
    ...
    [Fact(DisplayName = "Resilience-008: Empty response causes exception")]
