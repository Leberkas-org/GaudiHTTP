...
public sealed class Http2DecoderErrorCodeTests
{
    ...
    public void Should_DecodeNoError_WhenInGoAway()
    {
    ...
    public void Should_DecodeProtocolError_WhenInRstStream()
    {
        var frame = new RstStreamFrame(1, Http2ErrorCode.ProtocolError).Serialize();
        var decoder = new Http2FrameDecoder();
        var frames = decoder.Decode(frame);
        var rst = Assert.IsType<RstStreamFrame>(Assert.Single(frames));
    ...
    public void Should_DecodeInternalError_WhenInGoAway()
    {
    ...
    public void Should_DecodeFlowControlError_WhenInGoAway()
    {
    ...
    public void Should_DecodeSettingsTimeout_WhenInGoAway()
    {
    ...
    public void Should_DecodeStreamClosed_WhenInRstStream()
    {
    ...
    public void Should_DecodeFrameSizeError_WhenInRstStream()
    {
    ...
    public void Should_DecodeRefusedStream_WhenInRstStream()
    {
    ...
    public void Should_DecodeCancel_WhenInRstStream()
    {
    ...
    public void Should_DecodeCompressionError_WhenInGoAway()
    {
    ...
    public void Should_DecodeConnectError_WhenInRstStream()
    {
    ...
    public void Should_DecodeEnhanceYourCalm_WhenInGoAway()
    {
    ...
    public void Should_DecodeInadequateSecurity_WhenInRstStream()
    {
    ...
    public void Should_DecodeHttp11Required_WhenInGoAway()
    {
        var frame = new GoAwayFrame(0, Http2ErrorCode.Http11Required).Serialize();
        var decoder = new Http2FrameDecoder();
        var frames = decoder.Decode(frame);
        var goAway = Assert.IsType<GoAwayFrame>(Assert.Single(frames));
        Assert.Equal(Http2ErrorCode.Http11Required, goAway.ErrorCode);
    }
}
