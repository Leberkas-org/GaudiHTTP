...
/// </summary>
public sealed class AuthChallengeParserTests
{
    // ──────────────────────────────────────────────────────────
    //  AuthChallengeParser
    // ──────────────────────────────────────────────────────────

    [Fact(DisplayName = "RFC9110-11.2.1-AC-001: Single Basic challenge parsed")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-002: Multiple challenges in one header")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-003: Duplicate parameter name throws")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-004: Bearer with realm and scope")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-005: Scheme-only challenge (Negotiate)")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-006: Parameter values are case-insensitive keys")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-007: Quoted-string with escaped characters")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-008: Empty/null header throws")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.1-AC-009: Unquoted parameter values parsed")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-001: Basic auth generates valid Base64")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-002: Bearer generates token format")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-003: Custom params use quoted-string")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-004: Custom params escape quotes in values")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-005: Basic auth with empty password")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-006: Bearer rejects empty token")]
    ...
    [Fact(DisplayName = "RFC9110-11.2.2-AB-007: Custom scheme with no params returns scheme only")]
