...
/// </remarks>
public sealed class ConnectResponseTests
{
    // ── HTTP/1.1 ──────────────────────────────────────────────────────────────

    [Fact(DisplayName = "RFC9110-9.3.6-CON-001: CONNECT 200 ignores Content-Length")]
    ...
    [Fact(DisplayName = "RFC9110-9.3.6-CON-002: CONNECT 200 ignores Transfer-Encoding")]
    ...
    [Fact(DisplayName = "RFC9110-9.3.6-CON-003: CONNECT 407 processes body normally")]
    ...
    [Fact(DisplayName = "RFC9110-9.3.6-CON-004: Non-CONNECT 200 respects Content-Length")]
    ...
    [Fact(DisplayName = "RFC9110-9.3.6-CON-005: CONNECT 200 with CL and trailing data still returns empty body")]
    ...
    [Fact(DisplayName = "RFC9110-9.3.6-CON-006: HTTP/1.0 CONNECT 200 ignores Content-Length")]
    ...
    [Fact(DisplayName = "RFC9110-9.3.6-CON-007: HTTP/1.0 CONNECT 407 processes body normally")]
