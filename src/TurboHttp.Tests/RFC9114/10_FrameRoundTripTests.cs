...
{
    // ───────────────────────── Per-frame-type roundtrips ─────────────────────────

    [Fact(DisplayName = "RFC-9114-7-rt-001: DATA frame roundtrip preserves payload")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-002: HEADERS frame roundtrip preserves header block")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-003: CANCEL_PUSH frame roundtrip preserves push ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-004: SETTINGS frame roundtrip preserves all parameters")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-005: PUSH_PROMISE frame roundtrip preserves push ID and header block")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-006: GOAWAY frame roundtrip preserves stream ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-007: MAX_PUSH_ID frame roundtrip preserves push ID")]
    ...
    [Theory(DisplayName = "RFC-9114-7-rt-008: Roundtrip with large varint values across all single-value frame types")]
    [InlineData(0)]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-009: Empty DATA frame roundtrip")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-010: SETTINGS frame with no parameters roundtrip")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-011: Multiple frames encode-decode roundtrip via DecodeAll")]
    ...
    [Fact(DisplayName = "RFC-9114-7-rt-012: Re-encode decoded frame produces identical wire bytes")]
