...
public sealed class Http3FrameTests
{
    ...
    [Theory(DisplayName = "RFC-9114-7-enum-001: Frame type values match RFC 9114 §7.2")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.1-dat-001: DATA frame serializes empty payload")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.1-dat-002: DATA frame serializes payload")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.1-dat-003: DATA frame WriteTo advances span")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.2-hdr-001: HEADERS frame serializes header block")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.2-hdr-002: HEADERS frame empty block")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.3-cpush-001: CANCEL_PUSH frame serializes push ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.3-cpush-002: CANCEL_PUSH frame large push ID uses multi-byte varint")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.3-cpush-003: CANCEL_PUSH rejects negative push ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.4-set-001: SETTINGS frame empty parameters")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.4-set-002: SETTINGS frame with parameters")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.5-pp-001: PUSH_PROMISE frame serializes push ID and header block")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.5-pp-002: PUSH_PROMISE rejects negative push ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.6-ga-001: GOAWAY frame serializes stream ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.6-ga-002: GOAWAY frame with large stream ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.6-ga-003: GOAWAY rejects negative stream ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.7-mpid-001: MAX_PUSH_ID frame serializes push ID")]
    ...
    [Fact(DisplayName = "RFC-9114-7.2.7-mpid-002: MAX_PUSH_ID rejects negative push ID")]
    public void MaxPushIdFrame_rejects_negative()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new Http3MaxPushIdFrame(-1));
    }

    // ───────────────────────── Cross-cutting: SerializedSize == actual ─────────────────────────

    [Fact(DisplayName = "RFC-9114-7-cross-001: SerializedSize matches actual byte count for all frame types")]
    ...
    [Fact(DisplayName = "RFC-9114-7-cross-002: WriteTo returns SerializedSize for all frame types")]
    ...
    // ───────────────────────── Large varint payloads ─────────────────────────

    [Fact(DisplayName = "RFC-9114-7.2.1-dat-004: DATA frame with large payload uses multi-byte length")]
