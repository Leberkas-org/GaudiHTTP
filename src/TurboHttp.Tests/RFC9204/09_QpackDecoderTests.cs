...
{
    // ── Static table indexed headers (§4.5.2) ───────────────────────────

    /// RFC 9204 §4.5.2 — Static table indexed header decodes correctly
    [Fact(DisplayName = "RFC9204-4.5.2-DEC-001: Static indexed header decoded")]
    ...
    [Fact(DisplayName = "RFC9204-4.5.2-DEC-002: Multiple static indexed headers decoded")]
    ...
    // ── Dynamic table indexed headers (§4.5.2) ──────────────────────────

    /// RFC 9204 §4.5.2 — Dynamic table entry decoded via pre-base relative index
    [Fact(DisplayName = "RFC9204-4.5.2-DEC-003: Dynamic indexed header decoded")]
    ...
    // ── Literal with static name reference (§4.5.4) ─────────────────────

    /// RFC 9204 §4.5.4 — Literal with static name reference decoded
    [Fact(DisplayName = "RFC9204-4.5.4-DEC-004: Literal with static name ref decoded")]
    ...
    // ── Literal without name reference (§4.5.6) ─────────────────────────

    /// RFC 9204 §4.5.6 — Literal without name reference decoded
    [Fact(DisplayName = "RFC9204-4.5.6-DEC-005: Literal without name ref decoded")]
    ...
    // ── NEVERINDEX / sensitive headers (§4.5.4 with N bit) ──────────────

    /// RFC 9204 §7.1 — Sensitive header (never-indexed) decoded correctly
    [Fact(DisplayName = "RFC9204-7.1-DEC-006: Sensitive header never-indexed decoded")]
    ...
    // ── Huffman decoding (§4.1.2) ───────────────────────────────────────

    /// RFC 9204 §4.1.2 — Huffman-encoded string literals decoded
    [Fact(DisplayName = "RFC9204-4.1.2-DEC-007: Huffman encoded values decoded")]
    ...
    // ── Required Insert Count validation (§4.5.1.1) ─────────────────────

    /// RFC 9204 §4.5.1.1 — Required Insert Count exceeding known count throws
    [Fact(DisplayName = "RFC9204-4.5.1-DEC-008: RIC exceeding known insert count throws")]
    ...
    // ── Blocked stream handling (§2.1.2) ────────────────────────────────

    /// RFC 9204 §2.1.2 — TryDecode returns blocked when RIC exceeds known insert count
    [Fact(DisplayName = "RFC9204-2.1.2-DEC-009: TryDecode returns blocked status")]
    ...
    [Fact(DisplayName = "RFC9204-2.1.2-DEC-010: TryDecode throws when blocked limit reached")]
    ...
    // ── Section Acknowledgment emission (§4.4.1) ────────────────────────

    /// RFC 9204 §4.4.1 — Section Acknowledgment emitted when dynamic table referenced
    [Fact(DisplayName = "RFC9204-4.4.1-DEC-011: Section Acknowledgment emitted")]
    ...
    [Fact(DisplayName = "RFC9204-4.4.1-DEC-012: No decoder instructions for static-only block")]
    ...
    // ── Post-base indexed (§4.5.3) — manual wire format ─────────────────

    /// RFC 9204 §4.5.3 — Post-base indexed header field decoded
    [Fact(DisplayName = "RFC9204-4.5.3-DEC-013: Post-base indexed header decoded")]
    ...
    // ── Literal with post-base name ref (§4.5.5) — manual wire format ───

    /// RFC 9204 §4.5.5 — Literal with post-base name reference decoded
    [Fact(DisplayName = "RFC9204-4.5.5-DEC-014: Literal with post-base name ref decoded")]
    ...
    // ── Empty header block (prefix only) ────────────────────────────────

    /// RFC 9204 — Empty header block with no fields
    [Fact(DisplayName = "RFC9204-4.5-DEC-015: Empty header block decoded")]
