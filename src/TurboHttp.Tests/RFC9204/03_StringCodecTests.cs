...
/// </summary>
public sealed class QpackStringCodecTests
{
    /// RFC 9204 §4.1.2 — Plain string roundtrip
    [Theory(DisplayName = "RFC9204-4.1.2-STR-001: Plain string roundtrip")]
    [InlineData("hello")]
    [InlineData("GET")]
    ...
    [Theory(DisplayName = "RFC9204-4.1.2-STR-002: Huffman-encoded string roundtrip")]
    ...
    [Fact(DisplayName = "RFC9204-4.1.2-STR-003: Empty string roundtrip")]
    ...
    [Fact(DisplayName = "RFC9204-4.1.2-STR-004: Auto-selects Huffman when it produces shorter output")]
    ...
    [Fact(DisplayName = "RFC9204-4.1.2-STR-005: Decode rejects truncated string data")]
    ...
    [Fact(DisplayName = "RFC9204-4.1.2-STR-006: Decode rejects empty input")]
