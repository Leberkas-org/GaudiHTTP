...
/// Provides zero-copy encoding to <see cref="Span{T}"/>
...
public static class FrameEncoder
{
    ...
    public static int EncodeData(ReadOnlySpan<byte> payload, Span<byte> destination)
    {
        ...
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.Data) + QuicVarInt.EncodedLength(payloadSize);
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.Data, span);
        span = span[written..];
    ...
    public static int EncodeHeaders(ReadOnlySpan<byte> headerBlock, Span<byte> destination)
    {
        ...
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.Headers) + QuicVarInt.EncodedLength(payloadSize);
        var totalSize = prefixSize + payloadSize;
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.Headers, span);
        span = span[written..];
        written = QuicVarInt.Encode(payloadSize, span);
        span = span[written..];
    ...
    public static int EncodeCancelPush(long pushId, Span<byte> destination)
    {
        ...
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.CancelPush) + QuicVarInt.EncodedLength(payloadSize);
        var totalSize = prefixSize + payloadSize;
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.CancelPush, span);
        span = span[written..];
        written = QuicVarInt.Encode(payloadSize, span);
        span = span[written..];
    ...
    public static int EncodeSettings(IReadOnlyList<(long Identifier, long Value)> parameters, Span<byte> destination)
    {
        ...
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.Settings) + QuicVarInt.EncodedLength(payloadSize);
        var totalSize = prefixSize + payloadSize;
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.Settings, span);
        span = span[written..];
        written = QuicVarInt.Encode(payloadSize, span);
        span = span[written..];
    ...
    public static int EncodePushPromise(long pushId, ReadOnlySpan<byte> headerBlock, Span<byte> destination)
    {
        ...
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.PushPromise) + QuicVarInt.EncodedLength(payloadSize);
        var totalSize = prefixSize + payloadSize;
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.PushPromise, span);
        span = span[written..];
        written = QuicVarInt.Encode(payloadSize, span);
        span = span[written..];
    ...
    public static int EncodeGoAway(long streamId, Span<byte> destination)
    {
        ...
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.GoAway) + QuicVarInt.EncodedLength(payloadSize);
        var totalSize = prefixSize + payloadSize;
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.GoAway, span);
        span = span[written..];
        written = QuicVarInt.Encode(payloadSize, span);
        span = span[written..];
    ...
    public static int EncodeMaxPushId(long pushId, Span<byte> destination)
    {
        ...
        var payloadSize = QuicVarInt.EncodedLength(pushId);
        var prefixSize = QuicVarInt.EncodedLength((long)FrameType.MaxPushId) + QuicVarInt.EncodedLength(payloadSize);
        var totalSize = prefixSize + payloadSize;
        ...
        var span = destination;
        var written = QuicVarInt.Encode((long)FrameType.MaxPushId, span);
        span = span[written..];
        written = QuicVarInt.Encode(payloadSize, span);
        span = span[written..];
        QuicVarInt.Encode(pushId, span);
