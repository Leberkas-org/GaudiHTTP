...
public sealed class UniStream
{
        ...
        out int bytesConsumed)
    {
        ...
        if (typeValue == (long)StreamType.Control)
        {
        ...
        if (typeValue == (long)StreamType.Push)
        {
            routing = UniStreamRouting.Push;
            return true;
        }

        if (typeValue == (long)StreamType.QpackEncoder)
        {
        ...
        if (typeValue == (long)StreamType.QpackDecoder)
        {
