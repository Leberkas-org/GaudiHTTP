...
internal sealed class Settings
{
    ...
    /// </summary>
    public long? this[long identifier] => _parameters.TryGetValue(identifier, out var value) ? value : null;
    ...
    public static Settings Deserialize(ReadOnlySpan<byte> payload)
    {
        ...
        while (payload.Length > 0)
        {
            ...
            {
                throw new HttpProtocolException("Incomplete setting identifier in SETTINGS payload.");
            }
            ...
            {
                throw new HttpProtocolException("Incomplete setting value in SETTINGS payload.");
            }
            ...
            if (!settings._parameters.TryAdd(identifier, value))
            {
                throw new HttpProtocolException(
