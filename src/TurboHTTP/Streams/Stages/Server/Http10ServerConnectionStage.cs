...
internal sealed class Http10ServerConnectionStage : GraphStage<ServerConnectionShape>
{
    ...
    private readonly Outlet<TurboHttpContext> _outRequest = new("Http10Connection.Out.Request");
    private readonly Inlet<TurboHttpContext> _inResponse = new("Http10Connection.In.Response");
    ...
    public Http10ServerConnectionStage(TurboServerOptions options, IServiceProvider? services = null)
    {
        _options = options;
        _services = services;
    }
