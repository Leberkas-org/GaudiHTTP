...
public sealed class RequestLineParserSpec
{
    ...
    public void TryParse_should_parse_simple_get_request()
    {
        ...
        Assert.True(RequestLineParser.TryParse(line, int.MaxValue, out var method, out var target, out var version,
            out var consumed));
    ...
    public void TryParse_should_parse_http10_post()
    {
        ...
        Assert.True(RequestLineParser.TryParse(line, int.MaxValue, out var method, out var target, out var version, out _));
    ...
    public void TryParse_should_parse_options_asterisk()
    {
        ...
        Assert.True(RequestLineParser.TryParse(line, int.MaxValue, out var method, out var target, out _, out _));
    ...
    public void TryParse_should_parse_absolute_form()
    {
        ...
        Assert.True(RequestLineParser.TryParse(line, int.MaxValue, out _, out var target, out _, out _));
    ...
    public void TryParse_should_throw_when_method_invalid()
    {
        ...
        Assert.Throws<ArgumentException>(() => RequestLineParser.TryParse(line, int.MaxValue, out _, out _, out _, out _));
    }
}