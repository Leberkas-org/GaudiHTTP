...
public sealed class Http10ServerEncoderSpec
{
    ...
    public void Encode_should_always_return_zero()
    {
        ...
        var written = MakeEncoder(withDate: false).Encode(buf, ctx);
    ...
    public void EncodeDeferred_should_inject_Date_when_WriteDateHeader_true()
    {
        ...
        Assert.Contains("Date: ", Encoding.ASCII.GetString(buf.WrittenSpan[..written]));
    }
    ...
    public void EncodeDeferred_should_omit_Date_when_WriteDateHeader_false()
    {
        ...
        Assert.DoesNotContain("Date:", Encoding.ASCII.GetString(buf.WrittenSpan[..written]));
    }
