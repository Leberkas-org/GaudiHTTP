...
public sealed class Http11ServerBodyBackpressureSpec
{
    ...
    public void OnBodyMessage_should_emit_transport_data_for_each_read_completion()
    {
        ...
        sm.OnBodyMessage(new DrainReadComplete<int>(0,100));
        sm.OnBodyMessage(new DrainReadComplete<int>(0,200));
        sm.OnBodyMessage(new DrainReadComplete<int>(0,50));
    ...
    public void OnBodyMessage_failed_should_clear_outbound_pending_flag()
    {
        ...
        sm.OnBodyMessage(new DrainReadComplete<int>(0,10));
        sm.OnBodyMessage(new DrainReadFailed<int>(0,new Exception("simulated failure")));
