...
public sealed class Http3FieldValidatorSpec
{
    ...
    {
        var ex = Assert.Throws<HttpProtocolException>(() => FieldValidator.ValidateFieldName("content-Type"));
    ...
    {
        var ex = Assert.Throws<HttpProtocolException>(() => FieldValidator.ValidateConnectionSpecific(name, "value"));
    }
