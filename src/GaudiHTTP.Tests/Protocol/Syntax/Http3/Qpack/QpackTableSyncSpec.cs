...
public sealed class QpackTableSyncSpec
{
    ...
    public void Should_SyncDecoderTable_ViaEncoderInstructions()
    {
        ...
        var applied = sync.ProcessEncoderInstructions(encoder.EncoderInstructions.Span);
    ...
    public void Should_ResolveMultipleBlockedStreams_InBatch()
    {
        ...
        sync.ProcessEncoderInstructions(instructions1);
        sync.ProcessEncoderInstructions(instructions2);
    ...
    public void Should_RemoveBlockedStream_OnStreamCancellation()
    {
        ...
        var n = QpackDecoderInstructionWriter.WriteStreamCancellation(12, ref writer);
