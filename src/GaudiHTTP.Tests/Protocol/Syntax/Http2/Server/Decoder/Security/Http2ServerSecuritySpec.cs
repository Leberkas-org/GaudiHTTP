...
namespace GaudiHTTP.Tests.Protocol.Syntax.Http2.Server.Decoder.Security;
...
public sealed class Http2ServerSecuritySpec
{
    ...
    public void Many_small_headers_exceeding_total_size_should_be_rejected()
    {
        ...
        // rejecting during decode before the full list is materialized — a COMPRESSION_ERROR.
