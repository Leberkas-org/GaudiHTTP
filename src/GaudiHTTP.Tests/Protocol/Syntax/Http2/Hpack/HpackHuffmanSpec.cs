...
public sealed class HpackHuffmanSpec
{
    ...
    public void HuffmanCodec_should_detect_eos_padding_misuse()
    {
        ...
        var ex = Assert.Throws<HuffmanException>(() => HuffmanCodec.Decode(invalidData, outBuf));
    ...
    public void HuffmanCodec_should_reject_truncated_input()
    {
        ...
        var ex = Assert.Throws<HuffmanException>(() => HuffmanCodec.Decode(incompleteData, outBuf));
