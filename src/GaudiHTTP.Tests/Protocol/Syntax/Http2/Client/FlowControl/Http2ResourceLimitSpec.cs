...
public sealed class Http2ResourceLimitSpec
{
    ...
    public void Http2FrameDecoder_should_throw_http2_exception_when_10001_empty_data_frames_received()
    {
        ...
        var headersFrames = decoder.DecodeAll(new ReadOnlySequence<byte>(headersFrame), out _);
        ...
        {
            var frames = decoder.DecodeAll(new ReadOnlySequence<byte>(emptyData), out _);
        ...
        Assert.Throws<HttpProtocolException>(() => EnforceEmptyDataFloodThreshold(emptyDataCount));
    }
    ...
    public void Http2FrameDecoder_should_accept_10000_empty_data_frames_without_exception()
    {
        ...
        var headersFrame = BuildRawFrame(0x1, 0x4, 1, [0x88]);
        decoder.DecodeAll(new ReadOnlySequence<byte>(headersFrame), out _);
