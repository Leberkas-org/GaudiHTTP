...
public sealed class Http2DecoderStreamValidationSpec
{
    ...
    public void Http2FrameDecoder_should_set_end_headers_true_when_continuation_end_headers_flag_set()
    {
        ...
        var decoder = new FrameDecoder();
        var frames = decoder.DecodeAll(new ReadOnlySequence<byte>(Concat(headersBytes, contBytes)), out _);
    ...
    public void Http2FrameDecoder_should_return_fragment_bytes_when_continuation_frame_decoded()
    {
        ...
        var decoder = new FrameDecoder();
        var decoded = decoder.DecodeAll(new ReadOnlySequence<byte>(Concat(headersBytes, contBytes)), out _);
    ...
    public void Http2FrameDecoder_should_decode_hpack_fragment_correctly_when_headers_frame_round_tripped()
    {
        ...
        var decoder = new FrameDecoder();
        var decoded = decoder.DecodeAll(new ReadOnlySequence<byte>(bytes), out _);
