...
public sealed class Http2DecoderBasicFrameSpec
{
    ...
    public void Http2FrameDecoder_should_decode_settings_ack_frame()
    {
        ...
        var frames = new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(ack), out _);
        Assert.Single(frames);
    ...
    public void Http2FrameDecoder_should_reject_data_frame_on_stream_zero()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(frame), out _));
    ...
    public void Http2FrameDecoder_should_reject_data_frame_padded_with_empty_payload()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(frameBytes), out _));
    ...
    public void Http2FrameDecoder_should_reject_ping_frame_on_non_zero_stream()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(ping), out _));
    ...
    public void Http2FrameDecoder_should_reject_goaway_frame_on_non_zero_stream()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(goaway), out _));
    ...
    public void Http2FrameDecoder_should_reject_continuation_frame_without_preceding_headers()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(continuation), out _));
    ...
    public void Http2FrameDecoder_should_enforce_continuation_stream_matching()
    {
        ...
        var ex = Assert.Throws<HttpProtocolException>(() => new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(combined), out _));
    ...
    public void Http2FrameDecoder_should_ignore_unknown_frame_types()
    {
        ...
        var frames = new FrameDecoder().DecodeAll(new ReadOnlySequence<byte>(frameBytes), out _);
    ...
    public void Http2FrameDecoder_should_handle_reset_and_restart_decoding()
    {
        ...
        var frames1 = decoder.DecodeAll(new ReadOnlySequence<byte>(ping1), out _);
        Assert.Single(frames1);

        decoder.Reset();

        var ping2 = new PingFrame(new byte[8], isAck: true).Serialize();
        var frames2 = decoder.DecodeAll(new ReadOnlySequence<byte>(ping2), out _);
