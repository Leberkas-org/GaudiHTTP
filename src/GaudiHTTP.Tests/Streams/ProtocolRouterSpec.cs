...
{
    private static GaudiServerOptions MakeOptions() => new();

    [Fact(Timeout = 5000)]
    public void ResolveEngine_should_return_http10_for_http10_version()
    {
        var engine = ProtocolRouter.ResolveEngine(new Version(1, 0), MakeOptions());
    ...
    {
        var engine = ProtocolRouter.ResolveEngine(new Version(1, 1), MakeOptions());
    ...
    {
        var engine = ProtocolRouter.ResolveEngine(new Version(2, 0), MakeOptions());
    ...
    {
        var engine = ProtocolRouter.ResolveEngine(new Version(3, 0), MakeOptions());
    ...
    {
        var engine = ProtocolRouter.ResolveEngine(new Version(4, 0), MakeOptions());
    ...
    {
        var engine = ProtocolRouter.ResolveNegotiating(MakeOptions());
