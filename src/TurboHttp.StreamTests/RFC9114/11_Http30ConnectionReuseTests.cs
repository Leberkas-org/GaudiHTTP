...
/// <see cref="TurboHttp.Protocol.RFC9114.Http3ConnectionReuseEvaluator"/> instead of
/// <see cref="TurboHttp.Protocol.RFC9112.ConnectionReuseEvaluator"/>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class Http30ConnectionReuseTests : StreamTestBase
{
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9114-3.3-CR-001: HTTP/3 response dispatches to Http3ConnectionReuseEvaluator")]
    public async Task Should_UseHttp3Evaluator_When_ResponseVersionIs30()
    {
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9114-3.3-CR-002: HTTP/3 same-origin response produces KeepAlive decision")]
    public async Task Should_ProduceKeepAlive_When_Http3SameOriginResponse()
    {
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9114-3.3-CR-003: HTTP/3 response passes through stage unchanged")]
    public async Task Should_PassResponseThrough_When_Http3Response()
    {
        var response = MakeH3Response();
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9114-3.3-CR-004: HTTP/3 response has correct endpoint key")]
    public async Task Should_SetCorrectEndpointKey_When_Http3Response()
    {
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9114-3.3-CR-005: HTTP/2 response does NOT use Http3 evaluator")]
    public async Task Should_UseStandardEvaluator_When_ResponseVersionIs20()
    {
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9114-3.3-CR-006: Mixed HTTP/2 and HTTP/3 responses dispatched correctly")]
    public async Task Should_DispatchCorrectly_When_MixedVersionResponses()
    {
