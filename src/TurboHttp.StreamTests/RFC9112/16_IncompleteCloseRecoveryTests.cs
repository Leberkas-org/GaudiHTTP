...
/// </remarks>
public sealed class IncompleteCloseRecoveryTests : StreamTestBase
{
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9112-8-IC-001: Chunked without zero-chunk is incomplete")]
    public async Task Should_BeIncomplete_When_NoZeroChunk()
    {
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9112-8-IC-002: CL body truncated is incomplete")]
    public async Task Should_BeIncomplete_When_BodyTruncated()
    {
    ...
    [Fact(Timeout = 10_000, DisplayName = "RFC9112-8-IC-003: No CL + clean close is complete")]
    public async Task Should_Complete_When_NoCLAndCleanClose()
    {
    ...
    [Fact(DisplayName = "RFC9112-8-IC-004: Engine retries idempotent after incomplete")]
    public void Should_Retry_When_IdempotentAndIncomplete()
    {
    ...
    [Fact(DisplayName = "RFC9112-8-IC-005: Engine does not retry non-idempotent after incomplete")]
    public void Should_NotRetry_When_NonIdempotentAndIncomplete()
    {
