...
public sealed class ClientStateTests
{
    ...
    public async System.Threading.Tasks.Task Should_DisposeInboundItems_WhenDisposeAsyncCalled()
    {
    ...
    public async System.Threading.Tasks.Task Should_DisposeOutboundItems_WhenDisposeAsyncCalled()
    {
