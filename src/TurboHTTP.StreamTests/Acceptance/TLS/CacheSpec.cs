...
public sealed class CacheSpec : EngineTestBase
{
    ...
    public async Task Cache_should_serve_max_age_response_from_cache_over_https()
    {
        var callCount = 0;
    ...
    public async Task Cache_should_force_revalidation_with_no_cache_over_https()
    {
        var callCount = 0;
        var map = new ResponseMap()
            .On("/cache/no-cache", _ =>
    ...
    public async Task Cache_should_never_cache_no_store_response_over_https()
    {
        var map = new ResponseMap()
    ...
    public async Task Cache_should_send_if_none_match_on_etag_revalidation_over_https()
    {
        var map = new ResponseMap()
    ...
    [Fact(Timeout = 5000)]
    [Trait("RFC", "RFC9111-4.3.2")]
    public async Task Cache_should_send_if_modified_since_on_last_modified_revalidation_over_https()
    {
        var map = new ResponseMap()
    ...
    public async Task Cache_should_produce_different_cache_entries_per_vary_header_value_over_https()
    {
        var map = new ResponseMap()
        ...
        var request2 = new HttpRequestMessage(HttpMethod.Get, "https://localhost/cache/vary/Accept-Language");
        ...
        var request3 = new HttpRequestMessage(HttpMethod.Get, "https://localhost/cache/vary/Accept-Language");
    ...
    public async Task Cache_should_respect_s_maxage_by_shared_cache_over_https()
    {
        var callCount = 0;
        var map = new ResponseMap()
    ...
    public async Task Cache_should_enable_caching_with_expires_header_over_https()
    {
        var callCount = 0;
        var map = new ResponseMap()
            .On("/cache/expires", _ =>
    ...
    public async Task Cache_should_cache_private_response_by_private_cache_over_https()
    {
        var callCount = 0;
        var map = new ResponseMap()
            .On("/cache/private", _ =>
    ...
    public async Task Cache_should_not_cache_private_response_by_shared_cache_over_https()
    {
        var callCount = 0;
        var map = new ResponseMap()
            .On("/cache/private", _ =>
