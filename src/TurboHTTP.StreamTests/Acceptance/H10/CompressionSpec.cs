...
public sealed class CompressionSpec : EngineTestBase
{
    ...
    [Fact(Timeout = 5000)]
    [Trait("RFC", "RFC1945-10.3")]
    public async Task Compression_should_negotiate_accept_encoding_brotli()
    {
        var request = new HttpRequestMessage(HttpMethod.Get, "http://localhost/compress/negotiate")
        {
            Version = HttpVersion.Version10
    ...
    [Fact(Timeout = 5000)]
    [Trait("RFC", "RFC1945-10.3")]
    public async Task Compression_should_negotiate_no_accept_encoding_returns_identity()
    {
        var request = new HttpRequestMessage(HttpMethod.Get, "http://localhost/compress/negotiate")
        {
            Version = HttpVersion.Version10
