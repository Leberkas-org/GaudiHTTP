# Deferred Request Encoding

TCP client state machines defer request encoding until a transport is connected, ensuring `Transport` is always non-null when encoding runs.
