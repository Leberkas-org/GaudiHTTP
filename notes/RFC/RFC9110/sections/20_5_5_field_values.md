...
description: "Section 5.5: Field Values — RFC 9110 — HTTP Semantics"
tags: [RFC9110, HTTP-semantics, methods, status-codes, redirects, retries, content-negotiation, conditional-requests, field_values]
---
...
> **MUST**: message, a field parsing implementation MUST exclude such whitespace
...
> **SHOULD**: [RFC2047] encoding.  Specifications for newly defined fields SHOULD
   limit their values to visible US-ASCII octets (VCHAR), SP, and HTAB.
> **SHOULD**: A recipient SHOULD treat other allowed octets in field content (i.e.,
...
> **MUST**: a field value MUST either reject the message or replace each of those
...
> **MAY**: invalid; however, recipients MAY retain such characters for the sake
