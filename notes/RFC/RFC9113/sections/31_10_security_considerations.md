...
description: "Section 10: Security Considerations — RFC 9113 — HTTP/2"
tags: [RFC9113, HTTP/2, binary-framing, streams, multiplexing, flow-control, SETTINGS, HPACK, GOAWAY, WINDOW_UPDATE, security_considerations]
---
...
> **MUST**: translates an HTTP/2 request or response MUST validate fields
...
> **MUST**: forwarding (see Section 7.6.1 of [HTTP]) MUST remove or replace those
...
> **MAY**: This setting is only advisory, so endpoints MAY choose to send field
...
> **MUST NOT**: provided by TLS, MUST NOT be used with HTTP/2 (see Section 9.2).
...
> **SHOULD**: Intermediaries SHOULD retain padding for DATA frames but MAY drop
