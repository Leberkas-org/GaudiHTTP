...
description: "Preamble of RFC 9111 — HTTP Caching — Abstract, Status of This Memo, Copyright Notice"
tags: [RFC9111, HTTP-caching, freshness, validation, Cache-Control, max-age, Expires, conditional-requests, Vary, preamble]
---
