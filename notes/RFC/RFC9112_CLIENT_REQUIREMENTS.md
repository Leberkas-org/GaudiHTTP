---
title: RFC 9112 HTTP/1.1 Client-Side Requirements Analysis
description: >-
  Complete MUST/SHALL sweep with 91.5% compliance (75/82 requirements), request
  encoding, response decoding, persistent connections, pipelining, and
