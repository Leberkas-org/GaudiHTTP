---
title: RFC 9114 HTTP/3 Client-Side MUST Requirements — Extraction Report
description: >-
  Detailed extraction report documenting all 145 HTTP/3 client-side requirements
  with status breakdown, architecture changes, implementation roadmap,
