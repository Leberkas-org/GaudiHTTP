...
description: "Section 19.15: NEW_CONNECTION_ID Frames — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: and MUST be treated as a connection error of type
...
> **MUST NOT**: An endpoint MUST NOT send this frame if it currently requires that
...
> **MUST**: Connection ID MUST treat receipt of a NEW_CONNECTION_ID frame as a
   connection error of type PROTOCOL_VIOLATION.

   Transmission errors, timeouts, and retransmissions might cause the
   same NEW_CONNECTION_ID frame to be received multiple times.  Receipt
> **MUST NOT**: of the same frame multiple times MUST NOT be treated as a connection
...
> **MAY**: MAY treat that receipt as a connection error of type
   PROTOCOL_VIOLATION.
...
> **MUST**: MUST be less than or equal to the value in the Sequence Number field.
   Receiving a value in the Retire Prior To field that is greater than
> **MUST**: that in the Sequence Number field MUST be treated as a connection
...
> **MUST**: MUST ignore any Retire Prior To fields that do not increase the
