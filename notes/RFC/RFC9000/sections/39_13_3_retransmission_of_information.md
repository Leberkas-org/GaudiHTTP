...
description: "Section 13.3: Retransmission of Information — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST NOT**: The content of a RESET_STREAM frame MUST NOT change when it is
      sent again.
...
> **SHOULD**: frame from being sent too often.  An endpoint SHOULD stop sending
...
> **MUST**: *  The HANDSHAKE_DONE frame MUST be retransmitted until it is
      acknowledged.

> **SHOULD**: Endpoints SHOULD prioritize retransmission of data over sending new
...
> **MUST**: length, and path MTU.  A receiver MUST accept packets containing an
   outdated frame, such as a MAX_DATA frame carrying a smaller maximum
   data value than one found in an older packet.

> **SHOULD**: A sender SHOULD avoid retransmitting information from packets once
