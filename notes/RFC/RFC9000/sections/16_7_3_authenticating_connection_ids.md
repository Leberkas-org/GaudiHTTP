...
description: "Section 7.3: Authenticating Connection IDs — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: The values provided by a peer for these transport parameters MUST
...
> **MUST**: for servers).  Endpoints MUST validate that received transport
...
> **MUST**: An endpoint MUST treat the absence of the
...
> **MUST**: An endpoint MUST treat the following as a connection error of type
