...
description: "Section 19.16: RETIRE_CONNECTION_ID Frames — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: greater than any previously sent to the peer MUST be treated as a
   connection error of type PROTOCOL_VIOLATION.

> **MUST**: The sequence number specified in a RETIRE_CONNECTION_ID frame MUST
   NOT refer to the Destination Connection ID field of the packet in
> **MAY**: which the frame is contained.  The peer MAY treat this as a
   connection error of type PROTOCOL_VIOLATION.
...
> **MUST**: length connection ID MUST treat receipt of a RETIRE_CONNECTION_ID
