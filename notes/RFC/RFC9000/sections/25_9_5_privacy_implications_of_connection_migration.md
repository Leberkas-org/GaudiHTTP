---
title: "9.5.  Privacy Implications of Connection Migration"
rfc_number: 9000
rfc_section: "9.5"
source_url: "https://www.rfc-editor.org/rfc/rfc9000"
description: "Section 9.5: Privacy Implications of Connection Migration — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MAY**: At any time, endpoints MAY change the Destination Connection ID they
   transmit with to a value that has not been used on another path.

> **MUST NOT**: An endpoint MUST NOT reuse a connection ID when sending from more
...
> **MUST NOT**: Similarly, an endpoint MUST NOT reuse a connection ID when sending to
...
> **MAY**: in which case it MAY continue to use the current connection ID with
...
> **SHOULD NOT**: An endpoint SHOULD NOT initiate migration with a peer that has
...
> **SHOULD**: Section 9.4), so addresses SHOULD only be changed infrequently.
...
> **SHOULD**: SHOULD provide new connection IDs before peers migrate; see
