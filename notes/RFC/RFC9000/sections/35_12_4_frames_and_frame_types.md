...
description: "Section 12.4: Frames and Frame Types — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: that all frames can appear in 1-RTT packets.  An endpoint MUST treat
...
> **MUST**: An endpoint MUST treat the receipt of a frame of unknown type as a
...
> **MUST**: implementations of frame parsing, a frame type MUST use the shortest
