...
description: "Section 12.2: Coalescing Packets — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: Unit (PMTU) probes; see Section 14.4.1.  Receivers MUST be able to
...
> **SHOULD**: An endpoint SHOULD include multiple frames in a single packet if they
...
> **MUST**: separate and complete.  The receiver of coalesced QUIC packets MUST
