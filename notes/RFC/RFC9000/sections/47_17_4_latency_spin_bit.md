...
description: "Section 17.4: Latency Spin Bit — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: endpoint that does not support this feature MUST disable it, as
   defined below.

   Each endpoint unilaterally decides if the spin bit is enabled or
> **MUST**: disabled for a connection.  Implementations MUST allow administrators
...
> **MUST**: the administrator, endpoints MUST disable their use of the spin bit
