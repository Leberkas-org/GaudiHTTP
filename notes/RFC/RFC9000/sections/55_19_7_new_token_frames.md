...
description: "Section 19.7: NEW_TOKEN Frames — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST NOT**: packet.  The token MUST NOT be empty.  A client MUST treat receipt
