...
description: "Section 19.8: STREAM Frames — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: An endpoint MUST terminate the connection with error
