...
description: "Section 3.2: Receiving Stream States — RFC 9000 — QUIC: A UDP-Based Multiplexed and Secure Transport"
...
> **MUST**: numbered stream IDs MUST be created.  This ensures that the creation
...
> **MAY**: implementation MAY interrupt delivery of stream data, discard any
