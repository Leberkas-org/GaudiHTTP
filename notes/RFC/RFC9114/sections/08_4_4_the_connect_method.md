...
description: "Section 4.4: The CONNECT Method — RFC 9114 — HTTP/3"
tags: [RFC9114, HTTP/3, QUIC, variable-length-frames, unidirectional-streams, QPACK, SETTINGS, GOAWAY, server-push, the_connect_method]
---
...
> **MUST**: A CONNECT request MUST be constructed as follows:
...
> **MAY**: to be sent on the stream.  Extension frames MAY be used if
   specifically permitted by the definition of the extension.  Receipt
> **MUST**: of any other known frame type MUST be treated as a connection error
...
> **SHOULD NOT**: so clients SHOULD NOT close a stream for sending while they still
