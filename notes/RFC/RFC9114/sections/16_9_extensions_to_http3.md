---
title: "9.  Extensions to HTTP/3"
rfc_number: 9114
rfc_section: "9"
source_url: "https://www.rfc-editor.org/rfc/rfc9114"
description: "Section 9: Extensions to HTTP/3 — RFC 9114 — HTTP/3"
tags: [RFC9114, HTTP/3, QUIC, variable-length-frames, unidirectional-streams, QPACK, SETTINGS, GOAWAY, server-push, extensions_to_http3]
---
...
> **SHOULD**: not satisfy that requirement and SHOULD be treated as an error.

   Extensions that could change the semantics of existing protocol
> **MUST**: components MUST be negotiated before being used.  For example, an
