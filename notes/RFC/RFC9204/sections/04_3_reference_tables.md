...
description: "Section 3: Reference Tables — RFC 9204 — QPACK: Field Compression for HTTP/3"
tags: [RFC9204, QPACK, header-compression, HTTP/3, dynamic-table, static-table, blocking-references, encoder-instructions, decoder-instructions, reference_tables]
---
...
> **MUST**: line representation, it MUST treat this as a connection error of type
...
> **MUST NOT**: encoder MUST NOT cause a dynamic table entry to be evicted unless
...
> **MUST**: MUST treat this as a connection error of type
   QPACK_ENCODER_STREAM_ERROR.
...
> **MUST NOT**: The encoder MUST NOT set a dynamic table capacity that exceeds this
