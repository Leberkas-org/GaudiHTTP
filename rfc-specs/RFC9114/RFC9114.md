...
**Official RFC**: [RFC Editor](https://www.rfc-editor.org/rfc/rfc9114)
...
## How to Search This RFC

1. **Use Ctrl+F** to search within the document
2. **Look for section numbers** like "1.2", "3.1", etc.
3. **Search for keywords** like "MUST", "SHOULD", "MAY", "MUST NOT"
4. **Find specific topics** mentioned in the sections above
